...
class Model(nn.Module):
    def __init__(self):
        ...
        self.pnnx_fold_coords0_1_pnnx_fold_coords0_1 = self.load_pnnx_bin_as_parameter(archive, 'pnnx_fold_coords0.1.pnnx_fold_coords0.1', (1,8640,81,2), 'float32')
    ...
    def forward(self, v_0, v_1):
        ...
        v_140 = v_139.view(4, -1, 128)
        v_141 = torch.permute(input=v_134, dims=(0,1,3,4,2))
        v_142 = v_141.view(4, -1, 128)
        v_143 = torch.permute(input=v_140, dims=(0,2,1))
        ...
        v_172 = v_171.view(4, -1, 128)
        v_173 = torch.permute(input=v_166, dims=(0,1,3,4,2))
        v_174 = v_173.view(4, -1, 128)
        v_175 = torch.permute(input=v_172, dims=(0,2,1))
        ...
        v_208 = v_207.view(4, -1, 128)
        v_209 = torch.permute(input=v_202, dims=(0,1,3,4,2))
        v_210 = v_209.view(4, -1, 128)
        v_211 = torch.permute(input=v_208, dims=(0,2,1))
        ...
        v_239 = v_238.view(4, -1, 128)
        v_240 = torch.permute(input=v_233, dims=(0,1,3,4,2))
        v_241 = v_240.view(4, -1, 128)
        v_242 = torch.permute(input=v_239, dims=(0,2,1))
        ...
        v_275 = v_274.view(4, -1, 128)
        v_276 = torch.permute(input=v_269, dims=(0,1,3,4,2))
        v_277 = v_276.view(4, -1, 128)
        v_278 = torch.permute(input=v_275, dims=(0,2,1))
        ...
        v_306 = v_305.view(4, -1, 128)
        v_307 = torch.permute(input=v_300, dims=(0,1,3,4,2))
        v_308 = v_307.view(4, -1, 128)
        v_309 = torch.permute(input=v_306, dims=(0,2,1))
        ...
        v_342 = v_341.view(4, -1, 128)
        v_343 = torch.permute(input=v_336, dims=(0,1,3,4,2))
        v_344 = v_343.view(4, -1, 128)
        v_345 = torch.permute(input=v_342, dims=(0,2,1))
        ...
        v_373 = v_372.view(4, -1, 128)
        v_374 = torch.permute(input=v_367, dims=(0,1,3,4,2))
        v_375 = v_374.view(4, -1, 128)
        v_376 = torch.permute(input=v_373, dims=(0,2,1))
        ...
        v_409 = v_408.view(4, -1, 128)
        v_410 = torch.permute(input=v_403, dims=(0,1,3,4,2))
        v_411 = v_410.view(4, -1, 128)
        v_412 = torch.permute(input=v_409, dims=(0,2,1))
        ...
        v_440 = v_439.view(4, -1, 128)
        v_441 = torch.permute(input=v_434, dims=(0,1,3,4,2))
        v_442 = v_441.view(4, -1, 128)
        v_443 = torch.permute(input=v_440, dims=(0,2,1))
        ...
        v_476 = v_475.view(4, -1, 128)
        v_477 = torch.permute(input=v_470, dims=(0,1,3,4,2))
        v_478 = v_477.view(4, -1, 128)
        v_479 = torch.permute(input=v_476, dims=(0,2,1))
        ...
        v_507 = v_506.view(4, -1, 128)
        v_508 = torch.permute(input=v_501, dims=(0,1,3,4,2))
        v_509 = v_508.view(4, -1, 128)
        v_510 = torch.permute(input=v_507, dims=(0,2,1))
        ...
        v_543 = v_542.view(4, -1, 128)
        v_544 = torch.permute(input=v_537, dims=(0,1,3,4,2))
        v_545 = v_544.view(4, -1, 128)
        v_546 = torch.permute(input=v_543, dims=(0,2,1))
        ...
        v_574 = v_573.view(4, -1, 128)
        v_575 = torch.permute(input=v_568, dims=(0,1,3,4,2))
        v_576 = v_575.view(4, -1, 128)
        v_577 = torch.permute(input=v_574, dims=(0,2,1))
        ...
        v_610 = v_609.view(4, -1, 128)
        v_611 = torch.permute(input=v_604, dims=(0,1,3,4,2))
        v_612 = v_611.view(4, -1, 128)
        v_613 = torch.permute(input=v_610, dims=(0,2,1))
        ...
        v_641 = v_640.view(4, -1, 128)
        v_642 = torch.permute(input=v_635, dims=(0,1,3,4,2))
        v_643 = v_642.view(4, -1, 128)
        v_644 = torch.permute(input=v_641, dims=(0,2,1))
        ...
        v_677 = v_676.view(4, -1, 128)
        v_678 = torch.permute(input=v_671, dims=(0,1,3,4,2))
        v_679 = v_678.view(4, -1, 128)
        v_680 = torch.permute(input=v_677, dims=(0,2,1))
        ...
        v_708 = v_707.view(4, -1, 128)
        v_709 = torch.permute(input=v_702, dims=(0,1,3,4,2))
        v_710 = v_709.view(4, -1, 128)
        v_711 = torch.permute(input=v_708, dims=(0,2,1))
        ...
        v_744 = v_743.view(4, -1, 128)
        v_745 = torch.permute(input=v_738, dims=(0,1,3,4,2))
        v_746 = v_745.view(4, -1, 128)
        v_747 = torch.permute(input=v_744, dims=(0,2,1))
        ...
        v_775 = v_774.view(4, -1, 128)
        v_776 = torch.permute(input=v_769, dims=(0,1,3,4,2))
        v_777 = v_776.view(4, -1, 128)
        v_778 = torch.permute(input=v_775, dims=(0,2,1))
        ...
        v_811 = v_810.view(4, -1, 128)
        v_812 = torch.permute(input=v_805, dims=(0,1,3,4,2))
        v_813 = v_812.view(4, -1, 128)
        v_814 = torch.permute(input=v_811, dims=(0,2,1))
        ...
        v_842 = v_841.view(4, -1, 128)
        v_843 = torch.permute(input=v_836, dims=(0,1,3,4,2))
        v_844 = v_843.view(4, -1, 128)
        v_845 = torch.permute(input=v_842, dims=(0,2,1))
        ...
        v_878 = v_877.view(4, -1, 128)
        v_879 = torch.permute(input=v_872, dims=(0,1,3,4,2))
        v_880 = v_879.view(4, -1, 128)
        v_881 = torch.permute(input=v_878, dims=(0,2,1))
        ...
        v_909 = v_908.view(4, -1, 128)
        v_910 = torch.permute(input=v_903, dims=(0,1,3,4,2))
        v_911 = v_910.view(4, -1, 128)
        v_912 = torch.permute(input=v_909, dims=(0,2,1))
        ...
        v_1002 = v_1001.view(64, -1, 128)
        v_1003 = torch.permute(input=v_996, dims=(0,1,3,4,2))
        v_1004 = v_1003.view(64, -1, 128)
        v_1005 = torch.permute(input=v_1002, dims=(0,2,1))
        ...
        v_1034 = v_1033.view(64, -1, 128)
        v_1035 = torch.permute(input=v_1028, dims=(0,1,3,4,2))
        v_1036 = v_1035.view(64, -1, 128)
        v_1037 = torch.permute(input=v_1034, dims=(0,2,1))
        ...
        v_1070 = v_1069.view(64, -1, 128)
        v_1071 = torch.permute(input=v_1064, dims=(0,1,3,4,2))
        v_1072 = v_1071.view(64, -1, 128)
        v_1073 = torch.permute(input=v_1070, dims=(0,2,1))
        ...
        v_1101 = v_1100.view(64, -1, 128)
        v_1102 = torch.permute(input=v_1095, dims=(0,1,3,4,2))
        v_1103 = v_1102.view(64, -1, 128)
        v_1104 = torch.permute(input=v_1101, dims=(0,2,1))
        ...
        v_1137 = v_1136.view(64, -1, 128)
        v_1138 = torch.permute(input=v_1131, dims=(0,1,3,4,2))
        v_1139 = v_1138.view(64, -1, 128)
        v_1140 = torch.permute(input=v_1137, dims=(0,2,1))
        ...
        v_1168 = v_1167.view(64, -1, 128)
        v_1169 = torch.permute(input=v_1162, dims=(0,1,3,4,2))
        v_1170 = v_1169.view(64, -1, 128)
        v_1171 = torch.permute(input=v_1168, dims=(0,2,1))
        ...
        v_1204 = v_1203.view(64, -1, 128)
        v_1205 = torch.permute(input=v_1198, dims=(0,1,3,4,2))
        v_1206 = v_1205.view(64, -1, 128)
        v_1207 = torch.permute(input=v_1204, dims=(0,2,1))
        ...
        v_1235 = v_1234.view(64, -1, 128)
        v_1236 = torch.permute(input=v_1229, dims=(0,1,3,4,2))
        v_1237 = v_1236.view(64, -1, 128)
        v_1238 = torch.permute(input=v_1235, dims=(0,2,1))
        ...
        v_1271 = v_1270.view(64, -1, 128)
        v_1272 = torch.permute(input=v_1265, dims=(0,1,3,4,2))
        v_1273 = v_1272.view(64, -1, 128)
        v_1274 = torch.permute(input=v_1271, dims=(0,2,1))
        ...
        v_1302 = v_1301.view(64, -1, 128)
        v_1303 = torch.permute(input=v_1296, dims=(0,1,3,4,2))
        v_1304 = v_1303.view(64, -1, 128)
        v_1305 = torch.permute(input=v_1302, dims=(0,2,1))
        ...
        v_1338 = v_1337.view(64, -1, 128)
        v_1339 = torch.permute(input=v_1332, dims=(0,1,3,4,2))
        v_1340 = v_1339.view(64, -1, 128)
        v_1341 = torch.permute(input=v_1338, dims=(0,2,1))
        ...
        v_1369 = v_1368.view(64, -1, 128)
        v_1370 = torch.permute(input=v_1363, dims=(0,1,3,4,2))
        v_1371 = v_1370.view(64, -1, 128)
        v_1372 = torch.permute(input=v_1369, dims=(0,2,1))
        ...
        v_1405 = v_1404.view(64, -1, 128)
        v_1406 = torch.permute(input=v_1399, dims=(0,1,3,4,2))
        v_1407 = v_1406.view(64, -1, 128)
        v_1408 = torch.permute(input=v_1405, dims=(0,2,1))
        ...
        v_1436 = v_1435.view(64, -1, 128)
        v_1437 = torch.permute(input=v_1430, dims=(0,1,3,4,2))
        v_1438 = v_1437.view(64, -1, 128)
        v_1439 = torch.permute(input=v_1436, dims=(0,2,1))
        ...
        v_1472 = v_1471.view(64, -1, 128)
        v_1473 = torch.permute(input=v_1466, dims=(0,1,3,4,2))
        v_1474 = v_1473.view(64, -1, 128)
        v_1475 = torch.permute(input=v_1472, dims=(0,2,1))
        ...
        v_1503 = v_1502.view(64, -1, 128)
        v_1504 = torch.permute(input=v_1497, dims=(0,1,3,4,2))
        v_1505 = v_1504.view(64, -1, 128)
        v_1506 = torch.permute(input=v_1503, dims=(0,2,1))
        ...
        v_1539 = v_1538.view(64, -1, 128)
        v_1540 = torch.permute(input=v_1533, dims=(0,1,3,4,2))
        v_1541 = v_1540.view(64, -1, 128)
        v_1542 = torch.permute(input=v_1539, dims=(0,2,1))
        ...
        v_1570 = v_1569.view(64, -1, 128)
        v_1571 = torch.permute(input=v_1564, dims=(0,1,3,4,2))
        v_1572 = v_1571.view(64, -1, 128)
        v_1573 = torch.permute(input=v_1570, dims=(0,2,1))
        ...
        v_1606 = v_1605.view(64, -1, 128)
        v_1607 = torch.permute(input=v_1600, dims=(0,1,3,4,2))
        v_1608 = v_1607.view(64, -1, 128)
        v_1609 = torch.permute(input=v_1606, dims=(0,2,1))
        ...
        v_1637 = v_1636.view(64, -1, 128)
        v_1638 = torch.permute(input=v_1631, dims=(0,1,3,4,2))
        v_1639 = v_1638.view(64, -1, 128)
        v_1640 = torch.permute(input=v_1637, dims=(0,2,1))
        ...
        v_1673 = v_1672.view(64, -1, 128)
        v_1674 = torch.permute(input=v_1667, dims=(0,1,3,4,2))
        v_1675 = v_1674.view(64, -1, 128)
        v_1676 = torch.permute(input=v_1673, dims=(0,2,1))
        ...
        v_1704 = v_1703.view(64, -1, 128)
        v_1705 = torch.permute(input=v_1698, dims=(0,1,3,4,2))
        v_1706 = v_1705.view(64, -1, 128)
        v_1707 = torch.permute(input=v_1704, dims=(0,2,1))
        ...
        v_1740 = v_1739.view(64, -1, 128)
        v_1741 = torch.permute(input=v_1734, dims=(0,1,3,4,2))
        v_1742 = v_1741.view(64, -1, 128)
        v_1743 = torch.permute(input=v_1740, dims=(0,2,1))
        ...
        v_1771 = v_1770.view(64, -1, 128)
        v_1772 = torch.permute(input=v_1765, dims=(0,1,3,4,2))
        v_1773 = v_1772.view(64, -1, 128)
        v_1774 = torch.permute(input=v_1771, dims=(0,2,1))
        ...
        v_1801 = self.pnnx_fold_coords0_1_pnnx_fold_coords0_1
        ...
        v_1827 = v_1826.reshape(8640, 128, 9)
        v_1828 = v_1818.reshape(8640, 1, 128)
        ...
        v_1833 = v_1832.reshape(8640, 9, 2)
